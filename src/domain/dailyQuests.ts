...
/* ------------------------------------------------------------------ */
/* Deterministic seed -> shuffle (no Math.random)                      */
/* ------------------------------------------------------------------ */

/** Deterministic 32-bit string hash (djb2-style). Not for security — just a seed. */
 ...
 * for picking a handful of quest templates.
 */
